<template>
    <section>
        <div class="container">
            ...
            <span class="curent"><a href="">CURRENT SERIES</a></span>

            <div class="comics-list">
                <Comics v-for="(element, index) in comics" :key="index" :ComicObject="element" />
            <span class="more"><a href="">LOAD MORE</a></span>
            </div>
        </div>
    </section>
</template>
